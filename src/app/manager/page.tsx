...
export default async function ManagerPlatePage() {
  ...
  const [{ data: trainees }, { data: courses }, { data: categories }, { data: allPlates }, { data: visibleCats }, { data: completions }, { data: workshops }, { data: workshopCategories }] = await Promise.all([
